...
do
    aws s3 cp templates/$TEMPLATE s3://mb3moodle/$STACK_NAME/templates/$TEMPLATE 
done
...
aws cloudformation create-stack --stack-name moodle34 --template-url https://s3-eu-west-1.amazonaws.com/mb3moodle/$STACK_NAME/templates/00-master.yaml --parameters \
